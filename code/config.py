...
ATTACK_BUNDLE_BATCH_SIZE = int(os.getenv("ATTACK_BUNDLE_BATCH_SIZE", 20))
TRANSCRIPT_BATCH_SIZE = int(os.getenv("TRANSCRIPT_BATCH_SIZE", 20))
EVALUATION_BATCH_SIZE = int(os.getenv("EVALUATION_BATCH_SIZE", 20))
