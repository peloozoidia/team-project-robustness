...
def main() -> None:
  ...
  fig, ax = plt.subplots()
  bars = ax.bar(results_by_char.index, results_by_char.mean_score, label="LLM Evaluation")
  ax.bar_label(
  ...
  fig, ax = plt.subplots()
  bars = ax.bar(
    results_by_persona_key.index, results_by_persona_key.mean_score, label="LLM Evaluation"
  )
  ax.bar_label(
    bars,
  ...
  fig, ax = plt.subplots()
  bars = ax.bar(
    results_by_attack_key.index, results_by_attack_key.mean_score, label="LLM Evaluation"
  )
  ax.bar_label(
    bars,
